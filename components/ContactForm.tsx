    ...
    if (state.succeeded) {
        return <main>
            <body className="bg-[#202635]">
                <div className="container px-5 py-2 mx-auto mb-12">
                    <div className="flex flex-wrap -m-4 justify-center">
                        <div className="p-4 mt-36 w-2/3 sm:w-1/2 lg:w-1/3 bg-[#F1F1F1] rounded-xl">
                            ...
                            <div className="flex items-center flex-wrap justify-center ">
                                <Link href="/"><button className="edu-box hover:cursor-pointer">Back to home page</button>
                                </Link>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="p-2 w-3/4">
                            <div className="relative">
                                <form action="https://formspree.io/f/mjvdovve"
                                    ...
                                    <label className="leading-7 text-sm text-[#1E1E1E] jetbrains" htmlFor="name">
                                        Name
                                    </label>
                                    ...
                                    <ValidationError
                                        ...
                                        errors={state.errors}
                                    />
                                    <label className="leading-7 text-sm text-[#1E1E1E] jetbrains" htmlFor="email">
                                        Email
                                    </label>
                                    <input className="w-full bg-[#1D202B] rounded border border-[#4E597A] focus:border-[#20232E] focus:bg-[#15171E] focus:ring-2 focus:ring-[#B19DC5] text-base outline-none text-[#EDEDED] py-1 px-3 leading-8 transition-colors duration-200 ease-in-out jetbrains"
